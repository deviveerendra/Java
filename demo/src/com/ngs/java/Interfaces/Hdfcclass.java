...
public class Hdfcclass  implements Interfacebank  {
	...
	/*
	 *
	 * getInterestRate method is used to get the interest rate of Hdfc
	 * 
	 */

	public void getInterestRate(double a){
		System.out.println("Interest rate of Hdfc is "+a);
